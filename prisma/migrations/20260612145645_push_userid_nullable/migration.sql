...
INSERT INTO "new_Push" ("blobPath", "ciphertext", "createdAt", "deletableByViewer", "expireAfterDays", "expireAfterViews", "expireReason", "expiredAt", "expiresAt", "fileSize", "id", "kind", "note", "passphraseHash", "payloadDeleted", "retrievalStep", "slug", "userId", "views") SELECT "blobPath", "ciphertext", "createdAt", "deletableByViewer", "expireAfterDays", "expireAfterViews", "expireReason", "expiredAt", "expiresAt", "fileSize", "id", "kind", "note", "passphraseHash", "payloadDeleted", "retrievalStep", "slug", "userId", "views" FROM "Push";
DROP TABLE "Push";
